...
export default function ExperienceComponent() {
  ...
  return (
    <div className='grid grid-cols-6 grid-rows-6 grid-flow-col h-full pt-8 pl-8 pr-8'>
      ...
      <Fragment>
        <Accordion className='w-full' animate={customAnimation} open={open === 1}>
          <AccordionHeader onClick={() => handleOpen(1)} className='text-base text-white dark:hover:text-cyan-600 hover:text-yellow-300'>
        ...
        <Accordion className='w-full' animate={customAnimation} open={open === 2}>
          <AccordionHeader onClick={() => handleOpen(2)} className='text-base text-white dark:hover:text-cyan-600 hover:text-yellow-300'>
        ...
        <Accordion className='w-full mb-10' animate={customAnimation} open={open === 3}>
          <AccordionHeader onClick={() => handleOpen(3)} className='text-base text-white dark:hover:text-cyan-600 hover:text-yellow-300'>
